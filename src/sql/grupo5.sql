...
--
-- Host: 127.0.0.1    Database: grupo5
-- ------------------------------------------------------
...
INSERT INTO `localidad` (`id`, `nombre`, `partido_id`) VALUES (1,'La Plata',1);
...
INSERT INTO `motivo_consulta` (`id`, `nombre`) VALUES (1,'Receta Médica'),(2,'Control por Guardia'),(3,'Consulta'),(4,'Intento de Suicidio'),(5,'Interconsulta'),(6,'Otras');
...
INSERT INTO `obra_social` (`id`, `nombre`) VALUES (1,'IOMA'),(2,'OSDE'),(3,'OSECAC');
...
INSERT INTO `paciente` (`id`, `apellido`, `nombre`, `fecha_nac`, `lugar_nac`, `localidad_id`, `region_sanitaria_id`, `domicilio`, `genero_id`, `tiene_documento`, `tipo_doc_id`, `numero`, `tel`, `nro_historia_clinica`, `nro_carpeta`, `obra_social_id`) VALUES (1,'Mamona','Ramona','2018-09-04','2018-09-02',1,1,'msdnfljn6',2,1,1,10655236,'262949',151548,151484,2),(2,'Martinez','Claudia','2018-09-04','2018-09-02',1,1,'msdnfljn6',2,1,1,10655236,'262949',151548,151484,2),(3,'ds','adfasf','2018-09-06','',1,1,'dsffs',1,0,1,435,'',0,0,1),(4,'aaaaa','aaaa','2018-09-21','',1,1,'fdghdhfthgftgb',1,0,1,345254,'',0,0,1),(5,'qq','qq','2018-09-05','',1,2,'53453',1,0,1,45,'',0,0,1);
...
INSERT INTO `partido` (`id`, `nombre`, `region_sanitaria_id`) VALUES (1,'La Plata',11);
...
INSERT INTO `permiso` (`id`, `nombre`) VALUES (1,'usuario_crear');
...
INSERT INTO `region_sanitaria` (`id`, `nombre`) VALUES (1,'I'),(2,'II'),(3,'III'),(4,'IV'),(5,'V'),(6,'VI'),(7,'VII'),(8,'VIII'),(9,'IX'),(10,'X'),(11,'XI'),(12,'XII');
...
INSERT INTO `tipo_documento` (`id`, `nombre`) VALUES (1,' DNI'),(3,'CI'),(2,'LC'),(4,'LE'),(5,'Sin dni');
...
INSERT INTO `tipo_institucion` (`id`, `nombre`) VALUES (2,'Comisaría'),(1,'Hospital');
...
INSERT INTO `tratamiento_farmacologico` (`id`, `nombre`) VALUES (1,'Mañana'),(2,'Tarde'),(3,'Noche');
...
INSERT INTO `usuario` (`id`, `email`, `username`, `password`, `activo`, `updated_at`, `created_at`, `first_name`, `last_name`, `is_superuser`) VALUES (0,'admin@admin','admin','sinhash',1,NULL,NULL,'admin','admin',1);
...
-- Dump completed on 2018-09-23 16:21:41
